...
export const updatePassword = (passwords) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put('http://127.0.0.1:4000/api/v1/password/update', passwords, config)
...
export const updateUser = (id, userData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put(`http://127.0.0.1:4000/api/v1/admin/user/${id}`, userData, config)
